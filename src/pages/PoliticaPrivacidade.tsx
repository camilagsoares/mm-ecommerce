        ...
        <div>
            ...
            <div className="flex items-center justify-center">
                <div className="mt-8 w-3/4">
                    ...
                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 1 - INFORMAÇÕES GERAIS</p>
                    <p className="text-justify text-gray-600 mt-4">
                        A presente Política de Privacidade contém informações sobre coleta, uso, armazenamento, tratamento e proteção dos dados pessoais dos usuários e visitantes do site M&M Soluções, com a finalidade de demonstrar absoluta transparência quanto ao assunto e esclarecer a todos interessados sobre os tipos de dados que são coletados, os motivos da coleta e a forma como os usuários podem gerenciar ou excluir as suas informações pessoais.<br />
                        Esta Política de Privacidade aplica-se a todos os usuários e visitantes do site M&M Soluções e integra os Termos e Condições Gerais de Uso do site M&M Soluções, devidamente inscrita no CNPJ sob o nº 28.926.408/0001-08, situado em Alameda Jatobá, 11 – Portal da Serra, Santa Rita do Sapucaí - MG, 37539-472, doravante nominada M&M Soluções. <br />
                    ...
                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 2 - COMO RECOLHEMOS OS DADOS PESSOAIS DO USUÁRIO E DO VISITANTE?</p>
                    <p className="text-justify text-gray-600 mt-4">Os dados pessoais do usuário e visitante são recolhidos pela plataforma da seguinte forma:
                        (Realizar pergunta de múltipla escolha com opção outras)</p>
                    <p className="text-justify text-gray-600">Quando o usuário cria uma conta/perfil na plataforma M&M Soluções: esses dados são os dados de identificação básicos, como (exemplo: e-mail, nome completo, cidade de residência e profissão). A partir deles, podemos identificar o usuário e o visitante, além de garantir uma maior segurança e bem-estar às suas necessidades. Ficam cientes os usuários e visitantes de que seu perfil na plataforma estará acessível a todos demais usuários e visitantes da plataforma M&M Soluções. <br />
                        Quando um usuário e visitante acessa OU páginas do site M&M Soluções: as informações sobre interação e acesso são coletadas pela empresa para garantir uma melhor experiência ao usuário e visitante. Estes dados podem tratar sobre as palavras-chaves utilizadas em uma busca, o compartilhamento de um documento específico, comentários, visualizações de páginas, perfis, a URL de onde o usuário e visitante provêm, o navegador que utilizam e seus IPs de acesso, dentre outras que poderão ser armazenadas e retidas. <br />
                        Por intermédio de terceiro: a plataforma M&M Soluções recebe dados de terceiros, quando um usuário faz login com o seu perfil de um desses sites. A utilização desses dados é autorizada previamente pelos usuários junto ao terceiro em questão.
                        Outras
                    </p>

                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 3 - QUAIS DADOS PESSOAIS RECOLHEMOS SOBRE O USUÁRIO E VISITANTE?</p>
                    <p className="text-justify text-gray-600 mt-4">Os dados pessoais do usuário e visitante recolhidos são os seguintes:
                        <br />
                        (Realizar pergunta de múltipla escolha com opção outras)
                        <br />
                        Dados para a criação da conta/perfil na plataforma M&M Soluções: e-mail, nome completo, cidade de residência e profissão.
                        <br />
                    ...
                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 3 - PARA QUE FINALIDADES UTILIZAMOS OS DADOS PESSOAIS DO USUÁRIO E VISITANTE?</p>
                    <p className="text-justify text-gray-600 mt-4">
                        (Realizar questão múltipla escolha com outras) <br />
                    ...
                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 4 - POR QUANTO TEMPO OS DADOS PESSOAIS FICAM ARMAZENADOS?</p>
                    <p className="text-justify text-gray-600 mt-4">
                    ...
                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 5 - SEGURANÇA DOS DADOS PESSOAIS ARMAZENADOS</p>
                    <p className="text-justify text-gray-600 mt-4">
                    ...
                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 6 - COMPARTILHAMENTO DOS DADOS</p>
                    <p className="text-justify text-gray-600 mt-4">
                    ...
                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 6 - OS DADOS PESSOAIS ARMAZENADOS SERÃO TRANSFERIDOS A TERCEIROS?</p>
                    <p className="text-justify text-gray-600 mt-4">
                        Os dados pessoais não podem ser compartilhados com terceiros. <br />
                    ...
                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 07 – COOKIES OU DADOS DE NAVEGAÇÃO</p>
                    <p className="text-justify text-gray-600 mt-4">
                        ...
                        O usuário e o visitante da plataforma M&M Soluções manifesta conhecer e aceitar que pode ser utilizado um sistema de coleta de dados de navegação mediante à utilização de cookies. <br />
                    ...
                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 8 - CONSENTIMENTO</p>
                    <p className="text-justify text-gray-600 mt-4">
                        ...
                        O usuário tem direito de retirar o seu consentimento a qualquer tempo, para tanto deve entrar em contato através do e-mail comercial@mmsolind.com.
                    </p>


                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 9 - ALTERAÇÕES PARA ESSA POLÍTICA DE PRIVACIDADE</p>
                    <p className="text-justify text-gray-600 mt-4">
                    ...
                    <p className="text-justify text-gray-600 mt-4">SEÇÃO 10 – JURISDIÇÃO PARA RESOLUÇÃO DE CONFLITOS</p>
                    <p className="text-justify text-gray-600 mt-4">
